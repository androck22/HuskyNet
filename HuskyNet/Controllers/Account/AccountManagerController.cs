...
using HuskyNet.ViewModels;
using HuskyNet.ViewModels.Account;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Identity;
using Microsoft.AspNetCore.Mvc;

namespace HuskyNet.Controllers.Account
{
    public class AccountManagerController : Controller
    {
        ...
        private async Task<List<User>> GetAllFriend()
        {
            ...
            return await Task<List<User>>.Run(() => repository.GetFriendsByUser(result));
        }
        ...
        public async Task<IActionResult> AddFriend(string id)
        {
            ...
            return await Task<IActionResult>.Run(() => RedirectToAction("MyPage", "AccountManager"));
        }
        ...
        private async Task<ChatViewModel> GenerateChat(string id)
        {
            ...
            var mess = await Task<ChatViewModel>.Run(() => repository.GetMessages(result, friend));
